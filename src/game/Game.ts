...
export class Game {
    ...
    public set Difficulty(val: number) { this._difficulty = val; } 
    ...
    static Memento = class implements IMemento {
        ...
        public constructor(rows: number, cols: number, grid: CellState[][], isGameOver: boolean, activePlayer: CellState, scores: Map<CellState, number>, gameStarted: boolean) {
            this.Rows = rows;
            this.Cols = cols;
            this.Grid = grid;
    ...
    public GetState(): IMemento {
        ...
        const memento = new Game.Memento(this._rows, this._cols, gridCpy, this._isGameOver, this._activePlayer, scoresCpy, this.GameStarted);
        return memento;
    }
