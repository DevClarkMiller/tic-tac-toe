...
const DifficultySelector = ({ game, setGame }: GameProp) => {
    const options: Option[] = [ { value: Difficulty.Hard, label: <IoIosMan /> }, { value: Difficulty.Medium, label: <FaChild /> }, { value: Difficulty.Easy, label: <FaBaby /> }  ];
    ...
    return (
        <div className="d-flex justify-content-center align-items-center">
            ...
            <Select<Option, false> isDisabled={game.GameStarted} value={selectedOption} onChange={onSelect} options={options} isSearchable={false}/>
        </div>
    );
};
